...
class floatingPopulationList extends Component {
    ...
    callFloatPopulListApi = async () => {
            axios.get('https://api.bigdatahub.co.kr/v1/datahub/datasets/search.json?pid=1002332&TDCAccessKey=7b0da927040b6614e5d611a762f0d573ab279123e239949b40bc080a37ef60fb', {
            })
            .then( response => {
                try {
